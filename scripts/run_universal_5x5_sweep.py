...
以各数据集 configs/{dataset}_best.yaml 为基底，覆盖 universal 相关字段与 exp_tag。
"""
...
UNIVERSAL_OVR: Dict[str, Any] = {
    "polarity_adapter": "universal",
    "polarity_use_local_probe": True,
    "polarity_use_nk_probe": True,
    "polarity_use_structural_probe": True,
    "polarity_gate_tau": 0.05,
    "polarity_gate_margin": 0.02,
    "polarity_gate_min_confidence": 0.10,
